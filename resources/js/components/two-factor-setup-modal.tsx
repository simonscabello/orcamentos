    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Escaneie o QR Code ou informe a chave no seu aplicativo autenticador.',
                buttonText: 'Fechar',
            };
        }
        ...
        return {
            ...
            description:
                'Para concluir, escaneie o QR Code ou informe a chave no seu aplicativo autenticador.',
            buttonText: 'Continuar',
        };
