    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                description:
                    'Informe um dos seus códigos de recuperação para acessar a conta.',
                toggleText: 'usar código do aplicativo autenticador',
            };
        }
        ...
        return {
            ...
            description:
                'Informe o código mostrado no seu aplicativo autenticador.',
